...
if __name__ == '__main__':
    ...
    for k in range(begin,end+1,1):
        ...
        # opt.dataroot = '../datasets/LAG_database_part_1/splited_all/image/'
        opt.model = 'resnet'
        opt.name = 'AMD_' + opt.model + '_%d_%d' % (k,K) + suffix
        opt.dataset_mode = 'AMD'
        ...
        if opt.pretrain:
            opt.continue_train = True
            opt.epoch = '200'
            opt.pretrain_path = './checkpoints/AMD_cycle_gan_cnn_1_1_ours_aug_00002'
